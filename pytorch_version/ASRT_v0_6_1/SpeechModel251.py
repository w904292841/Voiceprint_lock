...
from ASRT_v0_6_1.general_function.file_wav import *
from ASRT_v0_6_1.general_function.file_dict import *
from ASRT_v0_6_1.general_function.gen_func import *
...
from ASRT_v0_6_1.readdata24 import DataSpeech
...
class ModelSpeech(): # 语音模型类
	...
	def Predict(self, data_input, input_len):
		...
		r = K.ctc_decode(base_pred, in_len, greedy = True, beam_width=100, top_paths=5)
