...
class Generator(nn.Module):
    ...
    def __init__(self,n_classes):
        ...
        self.layer1 = Conv_bn_pool(in_channels=inp.size(1), out_channels=48, kernel_size=(3, 3), stride=(1, 1),
                                   padding=(1, 1), pool='max', pool_size=(3,3), pool_stride=(1,1),pool_padding=(1,1))
    ...
    def forward(self, inp, tgt, batch_size):
...
class Discriminator(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer3_1 = Conv_bn_pool(in_channels=96, out_channels=128, kernel_size=(3, 3), stride=(1, 1),
                                   padding=(1, 1))
        self.layer3_2 = Conv_bn_pool(in_channels=128, out_channels=128, kernel_size=(3, 3), stride=(1, 1),
                                   padding=(1, 0), pool='max', pool_size=(2,2), pool_stride=(2,2),pool_padding=(1,1))
        self.layer4 = Conv_bn_dynamic_apool(in_channels=128, out_channels=64, kernel_size=(3, 3), stride=(1, 2),
                                   padding=(1, 1))
        self.layer5 = nn.Linear(64,1,bias=True)
